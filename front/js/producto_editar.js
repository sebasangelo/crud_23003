...
document.getElementById('metros').value = decodeURIComponent(data[5][1]);
document.getElementById('imagen').value = decodeURIComponent(data[6][1]);
...
function modificar(){
    ...
    let url = 'https://127.0.0.1:5000/productos/'+id;
